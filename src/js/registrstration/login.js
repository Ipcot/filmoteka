...
let email = ''
let password = '';
const btnMod = document.getElementById('btnM');
...
function onFormSubmit(e) {
    ...
    createUserWithEmailAndPassword(auth, email, password).then(successPromise ).catch(function (error) {
...
function successPromise() { 
    ...
    btnMod.classList.add('btn-is-hidden');
