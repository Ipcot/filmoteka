...
moviesAPI.fetchMoviesWithQuery(3); // ищем нужную страницу (defaut = 1)

// Ищем популярное:
moviesAPI.fetchPopularMovies(); // default = 1 страница
moviesAPI.fetchPopularMovies(5); // ищем нужную страницу

// Ищем по id:
moviesAPI.fetchMovieDetails(453395);

// Пример объекта, который возвращает промис 1 или 2 функции:
moviesAPI.fetchMoviesWithQuery(1).then(console.log);
